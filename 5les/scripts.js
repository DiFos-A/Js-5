...
{
    let sum = a + b;
    alert("a + b = " + Number(sum));

}
else{
    alert("A or B are not number");
}
...
if (typeof a == "number") 
{   
    console.log('function square(a) = ' + (a * a));
...
if(a <= 10, a >= 1)
{
    if(a == getRandomInRange(1, 10))
    {
        alert("Вы выиграли")
    }
    else
    {
        alert("Вы не угадали, ваше число -  " + a + " а выпало число - " + getRandomInRange(1, 10));
    }
}
